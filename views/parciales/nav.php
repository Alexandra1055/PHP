<nav aria-label="Global" class="flex items-center justify-between p-6 lg:px-8">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/controllers/about.php" class="<?= urlIs('/about.php') ? 'bg-gray-300 text-white' : 'text-gray-900' ?>-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">About</a>
        <a href="/controllers/contacto.php" class="<?= urlIs('/contacto.php') ? 'bg-gray-300 text-white' : 'text-gray-900' ?>-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50 dark:text-white dark:hover:bg-white/5">Contacto</a>
    </div>
